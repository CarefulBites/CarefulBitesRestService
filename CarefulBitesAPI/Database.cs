...
namespace CarefulBitesAPI
{
    ...
    public interface ICarefulBitesDbContext : IDisposable
    {
        ...
        DbSet<ItemTemplate> ItemTemplates { get; set; } // ItemTemplate
    ...
    public class CarefulBitesDbContext : DbContext, ICarefulBitesDbContext
    {
        ...
        public DbSet<ItemTemplate> ItemTemplates { get; set; } // ItemTemplate
    ...
    public class FakeCarefulBitesDbContext : ICarefulBitesDbContext
    {
        ...
        public FakeCarefulBitesDbContext()
        {
            ...
            ItemTemplates = new FakeDbSet<ItemTemplate>("ItemTemplateId");
    ...
    public class Category
    {
        ...
        /// <summary>
        /// Child ItemCategoryBindings where [ItemCategoryBinding].[CategoryId] point to this entity (FK__ItemCateg__Categ__32AB8735)
        /// </summary>
        //public virtual ICollection<ItemCategoryBinding> ItemCategoryBindings { get; set; } // ItemCategoryBinding.FK__ItemCateg__Categ__32AB8735
    ...
    public class Item
    {
        ...
        /// </summary>
        //public virtual ICollection<ItemCategoryBinding> ItemCategoryBindings { get; set; } // ItemCategoryBinding.FK__ItemCateg__ItemI__31B762FC
        ...
        /// <summary>
        /// Parent ItemType pointed by [Items].([ItemTypeId]) (FK__Items__ItemTypeI__395884C4)
        /// </summary>
        //public virtual ItemType ItemType { get; set; } // FK__Items__ItemTypeI__395884C4
    ...
    // ItemCategoryBinding
    public class ItemCategoryBinding
    {
        public int? ItemCategoryBindingId { get; set; } // ItemCategoryBindingId (Primary key)
        public int ItemId { get; set; } // ItemId
        ...
        /// <summary>
        /// Parent Category pointed by [ItemCategoryBinding].([CategoryId]) (FK__ItemCateg__Categ__32AB8735)
        /// </summary>
        //public virtual Category Category { get; set; } // FK__ItemCateg__Categ__32AB8735

        /// <summary>
        /// Parent Item pointed by [ItemCategoryBinding].([ItemId]) (FK__ItemCateg__ItemI__31B762FC)
        /// </summary>
        //public virtual Item Item { get; set; } // FK__ItemCateg__ItemI__31B762FC
    }
    ...
    public class User
    {
        ...
        public string Information { get; set; } // Information (length: 255)
    ...
    public class CategoryConfiguration : IEntityTypeConfiguration<Category>
    {
        public void Configure(EntityTypeBuilder<Category> builder)
        {
            ...
            builder.HasKey(x => x.CategoryId).HasName("PK__Category__19093A0BF761D813").IsClustered();
    ...
    public class ItemConfiguration : IEntityTypeConfiguration<Item>
    {
        public void Configure(EntityTypeBuilder<Item> builder)
        {
            ...
            //builder.HasOne(a => a.ItemType).WithMany(b => b.Items).HasForeignKey(c => c.ItemTypeId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__Items__ItemTypeI__395884C4");
        }
    }

    // ItemCategoryBinding
    public class ItemCategoryBindingConfiguration : IEntityTypeConfiguration<ItemCategoryBinding>
    {
        public void Configure(EntityTypeBuilder<ItemCategoryBinding> builder)
        {
            builder.ToTable("ItemCategoryBinding", "dbo");
            builder.HasKey(x => x.ItemCategoryBindingId).HasName("PK__ItemCate__B42FCC51D716DB39").IsClustered();

            builder.Property(x => x.ItemCategoryBindingId).HasColumnName(@"ItemCategoryBindingId").HasColumnType("int").IsRequired().ValueGeneratedOnAdd().UseIdentityColumn();
            builder.Property(x => x.ItemId).HasColumnName(@"ItemId").HasColumnType("int").IsRequired();
            builder.Property(x => x.CategoryId).HasColumnName(@"CategoryId").HasColumnType("int").IsRequired();

            // Foreign keys
            //builder.HasOne(a => a.Category).WithMany(b => b.ItemCategoryBindings).HasForeignKey(c => c.CategoryId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__ItemCateg__Categ__32AB8735");
            //builder.HasOne(a => a.Item).WithMany(b => b.ItemCategoryBindings).HasForeignKey(c => c.ItemId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__ItemCateg__ItemI__31B762FC");
        }
    }
    ...
    public class ItemTemplateConfiguration : IEntityTypeConfiguration<ItemTemplate>
    {
        ...
        {
            builder.ToTable("ItemTemplate", "dbo");
            builder.HasKey(x => x.ItemTemplateId).HasName("PK__ItemTemp__9A7BE2878F2171AB").IsClustered();

            builder.Property(x => x.ItemTemplateId).HasColumnName(@"ItemTemplateId").HasColumnType("int").IsRequired().ValueGeneratedOnAdd().UseIdentityColumn();
            builder.Property(x => x.Name).HasColumnName(@"Name").HasColumnType("varchar(50)").IsRequired(false).IsUnicode(false).HasMaxLength(50);
            builder.Property(x => x.CaloriesPer).HasColumnName(@"CaloriesPer").HasColumnType("int").IsRequired(false);
            builder.Property(x => x.Amount).HasColumnName(@"Amount").HasColumnType("float").HasPrecision(53).IsRequired();
            builder.Property(x => x.Unit).HasColumnName(@"Unit").HasColumnType("int").IsRequired();
    ...
    public class ItemTypeConfiguration : IEntityTypeConfiguration<ItemType>
    {
        public void Configure(EntityTypeBuilder<ItemType> builder)
        {
            ...
            builder.HasKey(x => x.ItemTypeId).HasName("PK__ItemType__F51540FBA52F782A").IsClustered();
    ...
    public class UserConfiguration : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(x => x.Information).HasColumnName(@"Information").HasColumnType("varchar(255)").IsRequired(false).IsUnicode(false).HasMaxLength(255);

            builder.HasIndex(x => x.Username).HasDatabaseName("UQ__Users__536C85E4B534B907").IsUnique();
        }
    }
